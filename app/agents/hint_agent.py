...
## 提示等级
当前是第 {hint_level} 次提示（共10次）：
- 第1-3次：方向性提示，暗示哪些嫌疑人的口供可能有问题，或哪条线索值得深挖
- 第4-6次：更具体的提示，指出凶手的某个破绽方向，或某两个证据之间的矛盾
- 第7-9次：近乎明示的提示，直接指出凶手口供的关键漏洞，但不说出凶手名字
- 第10次：最强提示，几乎指明凶手身份，但仍不说出名字
